...
public class Cryptohash {
	...
	//		byte[] values = new byte[32]; //32*8=256 bytes
	  //     random.nextBytes(values);
	        ...
	        SecureRandom random1 = SecureRandom.getInstance("NativePRNGNonBlocking");
	       ...
	       // random.nextBytes(values1); 
	        ...
	        SecureRandom random2 = SecureRandom.getInstance("NativePRNGNonBlocking"); //// 256 bit key for SHA256
